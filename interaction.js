...
criar_item_loja(item);
criar_item_loja2(item);

function criar_item_loja(item){
  ...
  article.className = "itens_loja";
        ...
        imagem.id = "imagen";
        imagem.src = item[i].url_img;
        article.appendChild(imagem);
            let div = document.createElement("div");
            div.className = "div";
            article.appendChild(div);   
                    let nome = document.createTextNode(item[i].nome);
                    div.appendChild(nome);

                    let div2 = document.createElement("div");
                    div2.className = "div2";
                    article.appendChild(div2);
                        let preco_nick = document.createTextNode("Preço: R$");
                        div2.appendChild(preco_nick);
                            let div3 = document.createElement("div");
                            div3.className = "div3";
                            article.appendChild(div3);
                                let preco = document.createTextNode(item[i].preco);
                                    ...
                                    article.appendChild(div4);
                                        ...
                                        div4.appendChild(desc_nick);
                                            ...
                                            article.appendChild(div5);
                                                let desc = document.createTextNode(item[i].descricao);
...
function criar_item_loja2(item){
    for(i=5;i<8;i++){
